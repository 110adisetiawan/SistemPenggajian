    ...
    <section class="content">
      <div class="box box-primary">
        ...
        <div class="box-footer">
           <button type="submit" class="btn btn-primary" data-toggle="modal"  data-target="#modal-default" ><b>-</b> Potong Gaji</button>
         </div>  
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form role="form" action="../proses/prosesInsertGaji.php?aksi=tambahPotongan" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Potongan</label>
                  <input type="input"  class="form-control" id="namapotongan" name="nama_potongan">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Jumlah Potongan</label>
                  <input type="input"  class="form-control" id="jumlahpotongan" name="jumlah_potongan">
                </div>
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php
                  ...
                  $dataGaji = $modelGaji->getDataPotongan();
                  foreach ($dataGaji as $key) 
                  {

                    ?>
            <tr>
              <td><?= $key['id_potongan'];?></td>
              <td><?= $key['nama_potongan'];?></td>
              <td><?= $key['jumlah_potongan'];?></td>
              <td>
